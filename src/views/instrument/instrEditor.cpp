...
, lfoSpeed(811, y + 430, 99, 0, "Speed", 0, 150), lfoA(811, y + 470, 99, 0, "Attack", 25, 150), add(1077, 290, "Add", -1, 6), loadBank(1077, 330, "Load Bank", -1, 6),adsr(Vector2f(200, 100)), lfoOffsetBar(Vector2f(1, 26))
